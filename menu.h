...
/**
 * @brief La classe Menu est une fenêtre affichant un menu permettant de lancer le jeu.
 */
...
private:
    ...
    /**
     * @brief menuBar Une barre de menu.
     */
    QMenuBar *menuBar;
    ...
    /**
     * @brief mapButtons stocker des boutons (utilisé pour répondre à l'exigence 'STL').
     */
